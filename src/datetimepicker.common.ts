import { Color, ContentView, Frame, Page, View } from '@nativescript/core';
import {
...
export class DateTimePickerBase implements DateTimePickerDefinition {
  static pickDate(
    ...
    style?: DateTimePickerStyleDefinition
  ): Promise<Date> {
...
export class DateTimePickerStyleBase implements DateTimePickerStyleDefinition {
  ...
  static create(view: View): DateTimePickerStyleBase {
    ...
    const pickerButtonOkColors = getColorsForClassName(
      view,
      BUTTON_OK_CSS_NAME
    );
    const pickerButtonCancelColors = getColorsForClassName(
      view,
      BUTTON_CANCEL_CSS_NAME
    );
    ...
    style.buttonCancelBackgroundColor =
      pickerButtonCancelColors.backgroundColor;
...
function getColorsForClassName(
  view: View,
  className: string
