...
import { dateComparer, getDateToday } from '../utils/date-utils';
...
export class DatePickerFieldBase
  extends PickerFieldBase
  implements DatePickerFieldDefinition {
  public maxDate: Date;
  public minDate: Date;
  public date: Date;
  ...
  private _initRegionalSettings() {
    ...
    this._nativeDateFormatter = LocalizationUtils.createNativeDateFormatter(
      this.dateFormat,
      this._nativeLocale
    );
  }
