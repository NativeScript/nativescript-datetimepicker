      ...
      <StackLayout class="p-20">
        ...
        <StackLayout :visibility="timeVisibility">
          ...
          <TimePickerField
            ...
            pickerOkText="Approve"
            pickerCancelText="Reject"
            pickerTitle="Confirm predefined time selection"
            pickerDefaultTime="22:00"
          ></TimePickerField>
          <StackLayout
            class="hr-light m-10"
            android:visibility="collapse"
        ...
        <StackLayout :visibility="dateTimeVisibility">
          ...
          <Label text="custom format" class="content"></Label>
          <DateTimePickerFields
            date="2019/02/24 01:00"
            dateFormat="'d': dd MMMM yyyy"
            timeFormat="'t': HH:mm"
          ></DateTimePickerFields>
          <StackLayout
            class="hr-light m-10"
...
export default {
  ...
  methods: {
      ...
      DateTimePicker.pickDate({
        ...
        if (selectedDate) {
          DateTimePicker.pickTime({
            ...
            if (selectedDateTime) {
              this.dateTimeText =
                this.getFormattedDate(selectedDateTime) +
                ' ' +
                this.getFormattedTime(selectedDateTime);
            }
          });
        }
      });
    ...
    expandCollapse: function(expandId) {
      ...
      this.dateTimeVisibility =
        expandId === 'dateTime' ? 'visible' : 'collapse';
